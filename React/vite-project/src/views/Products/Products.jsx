        ...
        <div className="gridProductos  d-flex p-2">
          {/* <aside className="m-0 p-0 d-block">
            ...
            <ul className="list-unstyled p-4">
              ...
              <li>
                <input type="checkbox"> Acción</input>
              </li>
              <li>
                <input type="checkbox"> Indie</input>
              </li>
              <li>
                <input type="checkbox"> Aventuras</input>
              </li>
              <li>
                <input type="checkbox"> RPG</input>
              </li>
              <li>
                <input type="checkbox"> Estrategia</input>
              </li>
              <li>
                <input type="checkbox"> Simulación</input>
              </li>
              <li>
                <input type="checkbox"> FPS</input>
              </li>
              <li>
                <input type="checkbox"> Deportes</input>
              </li>
              <li>
                <input type="checkbox"> MMO</input>
              </li>
            </ul>
          </aside> */}
